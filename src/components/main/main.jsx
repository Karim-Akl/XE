...
export default function Main() {
  return (
    // <div className="background-main  items-center justify-center md:gap-5 m-auto  relative   h-auto  w-full ">
      <div className="flex flex-col lg:flex-row justify-center items-center gap-16    relative bottom-[10%] md:bottom-[20%]  z-50 container">
        ...
        <div className="flex flex-col items-center md:mb-[10%] z-20 justify-center m-auto group  hover:translate-y-[-10%] transition duration-200">
          ...
          <div className="text-center flex flex-col">
            <p className="text-iconHover text-xl font-bold mt-2">
              استقدام من بنجلاديش
            </p>
            <p className="text-black text-lg mt-2 md:w-[100%] w-[80%] m-auto">
              نوفر عمالة منزلية مدربة وموثوقة من مختلف الجنسيات لضمان جودة
              الخدمة.
            </p>
          </div>
          <button className="text-text text-lg mt-2 px-4 py-2 rounded transition duration-200 group-hover:bg-background group-hover:text-iconHover">
            اقراء المزيد
          </button>
        </div>
        ...
        <div className="flex flex-col items-center md:mb-[5%] z-20 justify-center m-auto group  hover:translate-y-[-10%] transition duration-200">
          ...
          <div className="text-center flex flex-col">
            ...
            <p className="text-black text-lg mt-2md:w-[100%] w-[80%]  m-auto">
              نوفر عمالة منزلية مدربة وموثوقة من مختلف الجنسيات لضمان جودة
              الخدمة.
            </p>
          </div>
